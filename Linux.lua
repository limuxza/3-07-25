...
function Linux.Create(config)
    ...
    if config.Subtitle then
        SubtitleLabel = Linux.Instance("TextLabel", {
            ...
            TextColor3 = Color3.fromRGB(140, 140, 150), -- Cor mais discreta
            TextSize = 12, -- Tamanho menor
            TextXAlignment = Enum.TextXAlignment.Left,
            AutomaticSize = Enum.AutomaticSize.X,
            ZIndex = 2
        })
        
        -- Removido o UIGradient para deixar o subtítulo mais discreto
    ...
    -- Function to animate sliders when entering a tab
    ...
    -- Function to animate tab content transition
    ...
    function LinuxLib.Tab(config)
        ...
        local function SelectTab()
            ...
            -- Animate sliders in the new tab
        ...
        function TabElements.Button(config)
            ...
            Btn.MouseButton1Click:Connect(function()
                Linux:PlaySound("8968249849") -- Button sound
        ...
        function TabElements.Toggle(config)
            ...
            local function SetValue(newState)
                ...
                UpdateToggle(Toggle)
                Linux:PlaySound("7761034230") -- Toggle sound
    ...
    task.spawn(function()
        ...
        if DefaultTab and Tabs[DefaultTab] then
            ...
            -- Animate sliders in default tab
